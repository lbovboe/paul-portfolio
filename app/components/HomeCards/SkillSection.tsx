  ...
  return (
    <section className="relative overflow-hidden px-4 py-20">
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          <div className="inline-flex items-center gap-3 rounded-full border border-blue-200/60 bg-blue-100/80 px-6 py-3 backdrop-blur-sm dark:border-slate-700/60 dark:bg-slate-800/80 md:px-8 md:py-4">
            <Zap className="h-5 w-5 flex-shrink-0 text-blue-600 dark:text-cyan-400 md:h-7 md:w-7" />
