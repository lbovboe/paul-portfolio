...
const PlaygroundTeaser = () => {
  return (
    <div className="mx-auto flex max-w-3xl flex-col items-center gap-6 rounded-2xl border border-blue-200/50 bg-white/70 p-8 text-center shadow-lg backdrop-blur-xl transition-all duration-300 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-blue-500/20 dark:border-slate-700/50 dark:bg-slate-900/70 dark:hover:shadow-cyan-500/20 md:p-12">
      ...
      <p className="max-w-xl text-slate-600 dark:text-slate-300">
        Rotate, zoom, and pan a GLB model rendered with Three.js and React Three Fiber, on its own dedicated page.
      </p>
